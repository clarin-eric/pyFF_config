...
pyff_config_directory_path="${venv_path:-/dev/null/nonexistent}/etc/pyff_config/" ;
...
pyff_fetch_md() {
    ...
    svn export --revision '7127' --force --depth files 'https://svn.clarin.eu/aai/clarin-sp-metadata.xml' "${output_dir_path}/md_about_spf_sps.xml" || error="CLARIN SPF SAML metadata export from svn.clarin.eu repository -> exit status: $?; $error" &&
...
pyff_sign() {
    ...
    'xmlsectool.sh' --inFile 'output/beta_md_about_clarin_erics_idm.xml' --outFile 'output/beta_md_about_clarin_erics_idm.xml' $xmlsectool_parameters || error="pyff_sign: beta_md_about_clarin_erics_idm -> exit status: $?; $error"
...
pyff_verify_signatures() {
    ...
    'xmlsectool.sh' --inFile 'output/beta_md_about_clarin_erics_idm.xml' $xmlsectool_parameters || error="pyff_verify_signatures: beta_md_about_clarin_erics_idm -> exit status: $?; $error"
...
pyff_publish() {
    ...
    mv 'output/md_about_spf_sps.xml' 'output/prod_md_about_clarin_erics_idp.xml' 'output/prod_md_about_clarin_erics_idm.xml' 'output/beta_md_about_clarin_erics_idm.xml' 'output/prod_md_about_spf_idps.xml' 'output/prod_md_about_spf_sps.xml' -t '/srv/www/infra.clarin.eu/aai/' &&
